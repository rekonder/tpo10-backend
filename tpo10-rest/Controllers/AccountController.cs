...
using tpo10_rest.Providers;
using tpo10_rest.Results;
...
namespace tpo10_rest.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private string _frontendBaseUrl = ConfigurationManager.AppSettings["frontendBaseUrl"];
        ...
        [ResponseType(typeof(void))]
        public async Task<IHttpActionResult> ForgottenPassword(ForgottenPasswordBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        // POST api/Account/ChangeForgottenPassword
        [AllowAnonymous]
        [HttpPost]
        [Route("ChangeForgottenPassword")]
        [ResponseType(typeof(void))]
        public async Task<IHttpActionResult> ChangeForgottenPassword(ChangeForgottenPasswordBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [HttpPost]
        [Route("CreateAccount")]
        [ResponseType(typeof(CreateAccountViewModel))]
        public async Task<IHttpActionResult> CreateAccount(CreateAccountBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
